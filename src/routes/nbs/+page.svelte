<script lang="ts">
    ...
    function receivedNbs() {
        ...
        fr.onload = function () {
            ...
            templateCode =
                templateCode +
                `{\"id\":\"block\",\"block\":\"func\",\"args\":{\"items\":[{\"slot\": 0, \"item\":{\"id\":\"item\",\"data\":{\"item\":\"{Count:1b,DF_NBT:3700,id:\\"minecraft:music_disc_5\\",tag:{HideFlags:255,display:{Name:'{\\"italic\\":false,\\"extra\\":[{\\"color\\":\\"light_purple\\",\\"extra\\":[\\"SONG \\",{\\"color\\":\\"gray\\",\\"extra\\":[\\"» \\",{\\"color\\":\\"white\\",\\"text\\":\\"${title}\\"}],\\"text\\":\\"\\"}],\\"text\\":\\"\\"}],\\"text\\":\\"\\"}'}}}\"}}},{\"item\":{\"id\":\"bl_tag\",\"data\":{\"option\":\"False\",\"tag\":\"Is Hidden\",\"action\":\"dynamic\",\"block\":\"func\"}},\"slot\":26}]},\"data\":\"${title}\"},`;
            var slot = 1;
            var chestCount = 1;
            ...
            compress(templateCode).then((finalCode) => {
                ...
                let itemTag = `{display:{Name:'[{"text":"SONG ","color":"light_purple", "italic": false},{"text":"» ","color":"gray"},{"text":"${title}","color":"white"}]'},PublicBukkitValues:{"hypercube:codetemplatedata":'{"name":"&dSONG &7» &f${title}","version":1,"code":"${finalCode}","author":"red-df"}'}}`;
                console.log(itemTag);
                sendToSocket(
                    `give {Count:1b,id:"minecraft:note_block",tag:${itemTag}}`,
    ...
    function giveNbsPlayer() {
        ...
        let itemTag = `{Enchantments:[{id:"minecraft:lure",lvl:1}],HideFlags:1,display:{Name:'[{"text":"» ","color":"dark_purple", "italic": false},{"text":"Music Player","color":"light_purple"}]'},PublicBukkitValues:{"hypercube:codetemplatedata":'{"name":"&3» &dMusic Player","version":1,"code":"${nbsPlayerCode}","author":"DFOnline"}'}}`;
        sendToSocket(`give {Count:1b,id:"minecraft:jukebox",tag:${itemTag}}`, "Music Player has been sent to CodeClient!");
    }
</script>
